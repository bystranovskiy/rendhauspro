	...
	<table class="form-table itsec-settings-section">
		...
		<tr>
			...
			<td>
				<?php if ( $proxy_header ) : ?>
					<p class="description">
						<?php printf( esc_html__( 'Security Check Pro has automatically determined the correct header, %s.', 'it-l10n-ithemes-security-pro' ), '<code>' . esc_html( is_array( $proxy_header ) ? implode( ', ', $proxy_header ) : $proxy_header ) . '</code>' ); ?>
					</p>
				<?php else: ?>
