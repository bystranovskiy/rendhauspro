      ...
      <?php foreach ($terms as $term): ?>
          ...
          foreach ($posts as $post) :
            ...
            <div class="category-item">
              <a class="inner" href="/<?php echo $category?>-portfolio#<?php echo $term->slug?>">
              ...
              <?php if ($term->description): ?><span class="category-description  animate-header"><?php echo $term->description; ?></span><?php endif; ?>
              </a>
            </div>
